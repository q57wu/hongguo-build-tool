...
.text-input { padding: 8px 12px; border: 1px solid var(--c-border); border-radius: var(--r-sm); font-family: var(--f-mono); font-size: 13px; width: 300px; background: var(--c-surface); color: var(--c-text); outline: none; }
